...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.NexusIdentifier))]
  public unsafe partial class NexusIdentifierPrototype : ComponentPrototype<Quantum.NexusIdentifier> {
    public Quantum.QEnum32<Team> Team;
    partial void MaterializeUser(Frame frame, ref Quantum.NexusIdentifier result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.NexusIdentifier component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.NexusIdentifier result, in PrototypeMaterializationContext context = default) {
        result.Team = this.Team;
        MaterializeUser(frame, ref result, in context);
    }
  }
