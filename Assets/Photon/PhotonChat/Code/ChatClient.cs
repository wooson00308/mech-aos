                ...
                case StatusCode.Disconnect:
                    switch (this.State)
                    {
                        ...
                        default:
                            ...
                            #endif
                            this.listener.DebugReturn(LogLevel.Warning, string.Format("Got a unexpected Disconnect in ChatState: {0}. Server: {1} Trace: {2}", this.State, this.chatPeer.ServerAddress, stacktrace));
